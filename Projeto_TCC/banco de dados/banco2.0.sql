...
icone VARCHAR(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- -----------------------------------------------------
-- 12) TABELA: Subcategorias
-- -----------------------------------------------------
...
ALTER TABLE produto ADD COLUMN id_categoria INT AFTER preco;
ALTER TABLE produto ADD COLUMN id_subcategoria INT AFTER id_categoria;

ALTER TABLE produto 
    ADD FOREIGN KEY (id_categoria) REFERENCES categorias(id);

ALTER TABLE produto 
    ADD FOREIGN KEY (id_subcategoria) REFERENCES subcategorias(id);
    
ALTER TABLE categorias MODIFY icone LONGTEXT;
ALTER TABLE subcategorias MODIFY icone LONGTEXT;    
