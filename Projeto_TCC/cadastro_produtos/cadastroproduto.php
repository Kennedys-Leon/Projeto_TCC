...
<body>
    <form id="formProduto" action="cadastroprodutobd.php" method="post" class="form-cadastro" enctype="multipart/form-data">
        ...
        <div class="linha">
            <div class="campo">
                ...
                <select id="CampCategoria" name="id_categoria" required>
                    <option value="" disabled selected>Selecione</option>

                    <?php
                    require '../conexao.php';
                    $sql = $pdo->query("SELECT * FROM categorias ORDER BY nome ASC");
                    while ($cat = $sql->fetch(PDO::FETCH_ASSOC)) {
            ...
            <div class="campo">
                <label for="CampSubcategoria">Subcategoria:</label>
                <select id="CampSubcategoria" name="id_subcategoria" required disabled>
    ...
    <script>
        document.getElementById("CampCategoria").addEventListener("change", function () {
            let idCategoria = this.value;

            fetch("get_subcategorias.php?id=" + idCategoria)
                .then(response => response.json())
                .then(data => {
                    let subcat = document.getElementById("CampSubcategoria");
                    subcat.innerHTML = "";
