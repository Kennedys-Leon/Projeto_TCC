...
// Buscar apenas produtos da categoria "Rocket League"
$sql = "SELECT p.*, i.imagem 
        FROM produto p
        LEFT JOIN imagens i ON p.idproduto = i.idproduto
        WHERE p.categoria = 'Rocket League'
...
<head>
  ...
  <title>MaxAcess - Rocket League</title>
...
<body>
  ...
  <section class="content">
    <aside class="sidebar">
      <h3>Categorias</h3>
      <ul>
        <li><a href="#">Rocket League Básico</a></li>
        <li><a href="#">Rocket League Avançado</a></li>
        <li><a href="#">Rocket League Estratégico</a></li>
      </ul>
    </aside>
      ...
      <div class="product-list">
        ...
        <?php else: ?>
          <p style="text-align:center; font-size:18px; color:#888; margin-top:40px;">
            Nenhum produto Rocket League foi adicionado ainda. 😅<br>
