...
// Buscar apenas produtos da categoria "Fall Guys"
$sql = "SELECT p.*, i.imagem 
        FROM produto p
        LEFT JOIN imagens i ON p.idproduto = i.idproduto
        WHERE p.categoria = 'Fall Guys'
...
<head>
  ...
  <title>MaxAcess - Fall Guys</title>
...
<body>
  ...
  <section class="content">
    <aside class="sidebar">
      <h3>Categorias</h3>
      <ul>
        <li><a href="#">Fall Guys Iniciante</a></li>
        <li><a href="#">Fall Guys Avançado</a></li>
        <li><a href="#">Fall Guys Estratégico</a></li>
      </ul>
    </aside>
      ...
      <div class="product-list">
        ...
        <?php else: ?>
          <p style="text-align:center; font-size:18px; color:#888; margin-top:40px;">
            Nenhum produto Fall Guys foi adicionado ainda. 😅<br>
