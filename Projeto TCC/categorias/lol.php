...
// Buscar apenas produtos da categoria "League of Legends"
$sql = "SELECT p.*, i.imagem 
        FROM produto p
        LEFT JOIN imagens i ON p.idproduto = i.idproduto
        WHERE p.categoria = 'League of Legends'
...
<head>
  ...
  <title>MaxAcess - League of Legends</title>
...
<body>
  ...
  <section class="banner">
    <h1>Produtos League of Legends</h1>
    <div class="search">
      ...
      <div class="product-list">
        ...
        <?php else: ?>
          <p style="text-align:center; font-size:18px; color:#888; margin-top:40px;">
            Nenhum produto League of Legends foi adicionado ainda. 😅<br>
