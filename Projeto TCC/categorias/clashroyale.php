...
// Buscar apenas produtos da categoria "Clash Royale"
$sql = "SELECT p.*, i.imagem 
        FROM produto p
        LEFT JOIN imagens i ON p.idproduto = i.idproduto
        WHERE p.categoria = 'Clash Royale'
...
<head>
  ...
  <title>MaxAcess - Clash Royale</title>
...
<body>
  ...
  <section class="content">
    <aside class="sidebar">
      <h3>Categorias</h3>
      <ul>
        <li><a href="#">Clash Royale Básico</a></li>
        <li><a href="#">Clash Royale Avançado</a></li>
        <li><a href="#">Clash Royale Estratégico</a></li>
      </ul>
    </aside>
      ...
      <div class="product-list">
        ...
        <?php else: ?>
          <p style="text-align:center; font-size:18px; color:#888; margin-top:40px;">
            Nenhum produto Clash Royale foi adicionado ainda. 😅<br>
