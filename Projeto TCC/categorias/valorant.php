...
// Buscar apenas produtos da categoria "Valorant"
$sql = "SELECT p.*, i.imagem 
        FROM produto p
        LEFT JOIN imagens i ON p.idproduto = i.idproduto
        WHERE p.categoria = 'Valorant'
  ...
  <section class="content">
    <aside class="sidebar">
      ...
      <ul>
        ...
        <li><a href="#">Contas Valorant</a></li>
      </ul>
    </aside>
      ...
      <div class="product-list">
        ...
        <?php else: ?>
          <p style="text-align:center; font-size:18px; color:#888; margin-top:40px;">
            Nenhum produto Valorant foi adicionado ainda. 😅<br>
