  ...
  <section class="content">
    <aside class="sidebar">
      ...
      <ul>
        ...
        <li><a href="#">PUBG PC</a></li>
        <li><a href="#">PUBG Lite</a></li>
      </ul>
    </aside>
      ...
      <div class="product-list">
        ...
        <?php else: ?>
          <p style="text-align:center; font-size:18px; color:#888; margin-top:40px;">
            Nenhum produto PUBG foi adicionado ainda. 😅<br>
